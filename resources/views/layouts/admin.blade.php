        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
          ...
          <li class=" nav-item">
              <a class="d-flex align-items-center" href="{{url('admin/users')}}"><i data-feather="users"></i>
                  <span class="menu-title text-truncate" data-i18n="{{__('menus.Users')}}">{{__('menus.Users')}}</span></a>
          </li>
            @endif
...
{{--                    </li>--}}
            ...
            @if( $isAdmin)
            <li class=" nav-item">
                <a class="d-flex align-items-center" href="{{url('admin/verification_codes')}}"><i data-feather="image"></i>
