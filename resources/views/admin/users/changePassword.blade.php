...
@section('content')
    ...
    <div class="content-body"><!-- Basic Inputs start -->
        <section id="basic-input">
            <form action="{{url('admin/users/change_password')}}" method="post" >
                @csrf
            <div class="row">
                <div class="col-md-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6 col-md-6 col-12 mb-1">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="arabic_question" class="form-control dt-uname"   aria-label="jdoe1" aria-describedby="basic-icon-default-uname2" value="{{$user->name}}" readonly>
                                    </div>
                                </div>
                                <div class="col-xl-6 col-md-6 col-12 mb-1">
                                    <div class="form-group">
                                        <label class="form-label" for="arabic_answer">{{__('page.Phone')}}</label>
                                        <input type="text" id="arabic_answer" class="form-control dt-uname" aria-label="jdoe1" aria-describedby="basic-icon-default-uname2" value="{{$user->phone}}" readonly>
                                    </div>
                                </div>
...
{{--                                </div>--}}
                                ...
                                <div class="col-sm-9 ">
                                    <button type="submit" class="btn btn-primary mr-1 mb-1 mt-1">{{__('label.generate')}}</button>
