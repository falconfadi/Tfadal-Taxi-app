    ...
    <section class="app-user-list">
        ...
        <div class="card">
            <div class="card-header border-bottom ">
                ...
                @if(auth()->user()->can('view_driver') || $isAdmin)
                ...
                <table id="example" class="display user-list-table table table-bordered" style="width:90%">
                    ...
                    @foreach($drivers as $driver)
                        ...
                        <tr>
                            ...
                            <td>{{($driver->drivers_details->freeze)?__('page.Yes'):__('page.No')}}</td>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        @if(auth()->user()->can('verify_driver') || $isAdmin)
                                            ...
                                            @endif
                                        @endif
                                        @if(auth()->user()->can('freeze_driver') || $isAdmin)
                                            ...
                                            @endif
                                        @endif
                                        @if(auth()->user()->can('change_password_driver') || $isAdmin)
                                        ...
                                        @endif
                                        @if(auth()->user()->can('delete_driver') || $isAdmin)
