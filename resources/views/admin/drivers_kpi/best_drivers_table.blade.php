...
<div class="content-body">
    <!-- users list start -->
    <section class="app-user-list" id="basic-datatable">
        <!-- users filter start -->
        <div class="card">
...
{{--                        <th>Actions</th>--}}
            ...
            <div class="col-sm-6 ">
                <a type="button" class="btn btn-info mr-1 mb-1 mt-1" href="{{url('admin/kpi_drivers')}}">عودة </a>
            </div>
