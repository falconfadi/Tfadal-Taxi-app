    ...
    <section class="app-user-list">
        ...
        <div class="card">
            ...
            <div class="card-header">
                ...
                @if(auth()->user()->can('send_notification_user') || $isAdmin)
                    ...
                    <form class="add-new-user modal-content pt-0" name="add_offer" action="{{url('admin/notifications/store')}}" method="post">
                        ...
                        <div class="modal-body flex-grow-1">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control dt-full-name" name="title" id="title"  aria-label="John Doe" aria-describedby="basic-icon-default-fullname2" />
                            </div>
                            <div class="form-group">
                                <label class="form-label" for="body">{{__('page.Body')}}</label>
                                <input type="text" class="form-control dt-full-name" name="body" id="body"  aria-label="John Doe" aria-describedby="basic-icon-default-fullname2" />
                            </div>
