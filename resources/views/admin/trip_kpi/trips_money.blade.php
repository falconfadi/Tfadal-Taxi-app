                ...
                <div class="col-lg-12 col-md-12">
                    ...
                    <ul class="list-group">
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            <span>  مجموع أموال الشركة من {{$from}} إلى  {{$to}}</span>
                            <span class="badge badge-primary badge-pill">{{array_sum($companyFunds)}}</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            <span>  مجموع أموال الكباتن من {{$from}} إلى  {{$to}}</span>
                            <span class="badge badge-primary badge-pill">{{array_sum($driversFunds)}}</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            <span>المجموع:</span>
                            <span class="badge badge-primary badge-pill">{{array_sum($companyFunds)+array_sum($driversFunds)}}</span>
                        </li>
                    </ul>
                </div>
