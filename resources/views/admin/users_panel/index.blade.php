    ...
    <section class="app-user-list">
        ...
        <div class="card">
            <div class="card-header">
                ...
                @if(auth()->user()->can('add_user_panel') || $isAdmin)
                <a class="btn btn-primary waves-effect waves-float waves-light" id="" href="{{url('admin/users_panel/create')}}">{{__('page.Add_New')}}</a>
                @endif
            </div>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="{{url('admin/users_panel/edit/'.$user->id)}}">
                                            <i data-feather="edit-2" class="mr-50"></i>
                                            <span>{{__('page.Edit')}}</span>
                                        </a>
                                        @if($user->id != 2)
                                        <a class="dropdown-item confirm-text" href="{{url('admin/users_panel/delete/'.$user->id)}}">
