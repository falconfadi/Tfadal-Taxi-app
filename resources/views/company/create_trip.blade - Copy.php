                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-xl-6 col-md-12 col-12 mb5 mt-1">
    ...
    <script type="text/javascript">
        ...
        function initialize2() {
            ...
            map = new google.maps.Map(document.getElementById('map_canvas_2'),
                mapOptions);
            google.maps.event.addListener(map,'center_changed', function() {
                document.getElementById('latitude_to').value = map.getCenter().lat();
                document.getElementById('longitude_to').value = map.getCenter().lng();
            });
            $('<div/>').addClass('centerMarker').appendTo(map.getDiv())
                //do something onclick
                .click(function() {
