    ...
    if (SpeechRecognition !== undefined && SpeechRecognition !== null) {
      ...
      speechToText.on('click', function () {
        ...
        recognition.onresult = function (event) {
          $this.closest('.form-send-message.php').find('.message.php').val(event.results[0][0].transcript);
        };
...
// Add message.php to chat - function call on form submit
function enterChat(source) {
  var message = $('.message.php').val();
  if (/\S/.test(message)) {
